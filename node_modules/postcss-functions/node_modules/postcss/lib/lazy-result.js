 ...
 *
 * @example
 * const lazy = postcss([cssnext]).process(scss);
 */
...
var LazyResult = function () {
     ...
     *
     * @example
     * postcss([cssnext]).process(scss, { from: cssPath }).then(result => {
     ...
     *
     * @example
     * postcss([cssnext]).process(scss).then(result => {
     *   console.log(result.scss);
     * }).catch(error => {
     *   console.error(error);
     * });
    ...
    LazyResult.prototype.sync = function sync() {
        ...
        if (this.processing) {
            throw new Error('Use process(scss).then(cb) to work with async plugins');
        }
    ...
    _createClass(LazyResult, [{
        ...
        /**
         * An alias for the `scss` property. Use it with syntaxes
