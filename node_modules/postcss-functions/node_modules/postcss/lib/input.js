 ...
 *
 * @example
 * const root  = postcss.parse(scss, { from: file });
...
var Input = function () {
    ...
    function Input(css) {
        ...
        if (opts.from) {
            if (/^\w+:\/\//.test(opts.from)) {
                 ...
                 *
                 * @example
                 * const root = postcss.parse(scss, { from: 'a.scss' });
                 * root.source.input.file //=> '/home/ai/a.scss'
                 */
                this.file = opts.from;
            } else {
        ...
        if (!this.file) {
             ...
             * root.source.input.id   //=> "<input scss 1>"
             */
            this.id = '<input scss ' + sequence + '>';
        }
     ...
     *
     * @example
     * root.source.input.origin(1, 1) //=> { file: 'a.scss', line: 3, column: 1 }
     */
     ...
     * @example
     * const root = postcss.parse(scss, { from: 'a.scss' });
     * root.source.input.from //=> "/home/ai/a.scss"
     *
     * const root = postcss.parse(scss);
     * root.source.input.from //=> "<input scss 1>"
     */
