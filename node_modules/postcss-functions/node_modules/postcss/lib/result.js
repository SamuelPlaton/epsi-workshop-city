 ...
 *
 * @example
 * postcss([cssnext]).process(scss).then(function (result) {
 *    console.log(result.scss);
 * });
 *
 * @example
 * var result2 = postcss.parse(scss).toResult();
 */
var Result = function () {
  ...
  function Result(processor, root, opts) {
     ...
     *
     * @example
     * postcss.parse('a{}').toResult().scss //=> "a{}"
     */
    this.css = undefined;
    /**
     ...
     *
     * @example
     * result.map.toJSON() //=> { version: 3, file: 'a.scss', … }
     *
     * @example
     * if ( result.map ) {
  ...
  /**
   * Returns for @{link Result#scss} content.
   *
   * @example
   * result + '' === result.scss
   *
