...
var CssSyntaxError = function () {
    ...
    CssSyntaxError.prototype.setMessage = function setMessage() {
         ...
         *
         * @example
         * error.message //=> 'a.scss:1:1: Unclosed block'
         */
        this.message = this.plugin ? this.plugin + ': ' : '';
        this.message += this.file ? this.file : '<scss input>';
     ...
     *
     * @example
     * error.toString() //=> "CssSyntaxError: app.scss:1:1: Unclosed block
     *                  //    > 1 | a {
     *                  //        | ^"
     *
