 ...
 *
 * postcss(plugins).process(scss, { from, to }).then(result => {
 ...
 *
 * ```js
 * cleaner.process(scss, processOpts, pluginOpts)
 * // This is equivalent to:
 * postcss([ cleaner(pluginOpts) ]).process(scss, processOpts)
 * ```
 *
...
/**
 * Parses source scss and returns a new {@link Root} node,
 * which contains the source CSS nodes.
 *
 * @param {string|toString} scss   String with input CSS or any object
 ...
 * root1.append(root2).toResult().scss
 *
 * @function
 */
