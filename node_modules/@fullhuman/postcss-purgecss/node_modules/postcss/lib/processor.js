 ...
 * processor.process(css1).then(result => console.log(result.scss))
 * processor.process(css2).then(result => console.log(result.scss))
 */
var Processor =
/*#__PURE__*/
function () {
   ...
   *
   * @param {string|toString|Result} scss String with input CSS or any object
   ...
   *
   * @example
   * processor.process(scss, { from: 'a.scss', to: 'a.out.scss' })
   *   .then(result => {
