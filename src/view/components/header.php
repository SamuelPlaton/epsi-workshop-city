<div id="header" class="w-100 p-2 flex flex-row justify-between items-center">
    <div class="w-1/4">
        ...
        <button type="button">
            <img class="w-12" src="../../../public/images/icon.png" alt="icon logo" />
        </button>
    </div>
    ...
    <div id="burgermenu" class="fixed top-0 -ml-4 w-2/3 lg:w-1/4 h-screen" >
        <div class="flex justify-between">
            <button type="button">
                <img class="m-4 w-16 lg:w-24" src="../../../public/images/icon.png" alt="icon logo" />
            </button>
        ...
        <div class="flex flex-col">
            <div class="flex flex-row items-center m-auto py-1">
                ...
                <a href="" class="w-40 ml-2 text-white"> Accueil </a>
            </div>
            <div class="flex flex-row items-center m-auto py-1">
                ...
                <a href="" class="w-40 ml-2 text-white"> Poster un ticket </a>
            </div>
            <div class="flex flex-row items-center m-auto py-1">
                ...
                <a href="" class="w-40 ml-2 text-white" > Mon profil </a>
            </div>
            <div class="flex flex-row items-center m-auto py-1">
                ...
                <a href="" class="w-40 ml-2 text-white"> Aide </a>
            </div>
            <div class="flex flex-row items-center m-auto py-1">
                <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-box-arrow-in-right" fill="white" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M6 3.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 0-1 0v2A1.5 1.5 0 0 0 6.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-8A1.5 1.5 0 0 0 5 3.5v2a.5.5 0 0 0 1 0v-2z"/>
                ...
                <a href="" class="w-40 ml-2 text-white"> Déconnexion </a>
            </div>
        </div>
    </div>
</div>
